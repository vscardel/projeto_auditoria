...
<?php
	...
	$tabela = $obj_auditor->recuperaRespostas();
	...
	<body> 
		<form action="caixaEntradaAuditor.php" method="post">
		  ...
		  <table class="table">
		    ...
		    if(isset($tabela)){
		    	foreach ($tabela as $value) {
		    		echo '<tr> <td>'.$value['fk_siape_dirigente'].'</td>'.'<td>'.$value['relatorio'].'</td>'.
		    		'<td>'.$value['manifestacao'].'</td> </tr>'; 
		    	}
		    }
